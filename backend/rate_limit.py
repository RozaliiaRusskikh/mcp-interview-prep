...
# Sized to bound worst-case spend on gemini-2.5-flash-lite to under $5/month,
# not to Gemini's free-tier request limit — this project pays. At ~2,000
# input + ~300 answer + 512 thinking-budget tokens per exchange ($0.10 / $0.40
# per 1M tokens), one call costs ~$0.00052; 300/day * 30 days ≈ $4.73/month if
# the cap is hit every single day. Real usage well below the cap costs far
# less. Pair this with a monthly spend cap in AI Studio as a backstop.
DAILY_CAP = 300
